...
import { getStoriesResourceRouter } from './resources/StoriesResourceRouter';
...
const getApp = (): Express => {
    ...
    app.use('/orgs/:orgId/products/:productId/features/:featureId/stories', getStoriesResourceRouter());
